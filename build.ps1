# Local model-baked image builder for vllm-qwen3.6-fp8
$ErrorActionPreference = 'Stop'

$ModelFolder = 'D:\Gits\text-generation-webui\user_data\models\Qwen3.6-35B-A3B-Abliterated-Heretic-AWQ-4bit'
$ConfigsToStage = @()
...
$BuildCommand = "docker build $BuildArgs -f Dockerfile -t vllm-qwen3.6-fp8:latest \"$ModelFolder\""
...
try {
    ...
    Write-Host '
SUCCESS: vllm-qwen3.6-fp8 built successfully!' -ForegroundColor Green
} catch {
    Write-Host '
FAILURE: Failed to build vllm-qwen3.6-fp8.' -ForegroundColor Red
