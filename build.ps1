...
$ModelFolder = 'D:\Gits\text-generation-webui\user_data\models\Huihui-Qwen3.6-35B-A3B-abliterated-FP8-DYNAMIC'
$ConfigsToStage = @()
...
$BuildCommand = "docker build -f Dockerfile -t vllm-qwen3.6-fp8:latest \"$ModelFolder\""
